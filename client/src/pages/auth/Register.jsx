            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  value={password}
                  onChange={onChange}
                  className="appearance-none block w-full px-3 py-2 border border-[var(--line)] rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[var(--primary)] focus:border-[var(--primary)] sm:text-sm bg-transparent text-[var(--ink)] pr-10"
                />
                <button
                  type="button"
