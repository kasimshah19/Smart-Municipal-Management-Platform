...
export default function DepartmentOfficerDashboard() {
  ...
  const deptActions = [
    { label: 'View All Complaints', path: '/officer/complaints' },
    { label: 'Pending Verification', path: '/officer/complaints?status=COMPLETION_SUBMITTED' },
  ];
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-sm" style={{ color: 'var(--ink-light)' }}>
            Departmental performance and complaint resolution overview
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-1">
          <QuickActions actions={deptActions} />
        </div>
      </div>
